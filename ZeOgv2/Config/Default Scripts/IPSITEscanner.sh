...
echo '               _/--------      |   _   |/\\//'
echo '              /                /   / \   \ \/'
echo '   Hello my name is scanny!  /___/   \___\'
echo "${normal}============================ Hi. =========================================="
echo IP/site Scanner
echo Written by: Ghosty/DeaDHackS 
echo Important: Make sure you have installed NMAP.
echo 'Do not try to use this script for illegal activities im not the cause of it!'
echo NOTE: You can scan a normal device so not a site as long as you have his/her IP.
echo ===========================================================================
echo Lets setup our scan!!
echo Choose target by IP/url:
read target
